        ...
        {!mealPlan ? (
          <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center">
            ...
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              Our AI will create a personalized meal plan with breakfast, lunch, dinner, and snacks tailored to your {DIET_STYLE_LABELS[profile.dietStyle].toLowerCase()} diet.
            </p>
                ...
                <div key={day.day} className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
                  <div className="bg-gray-50 px-6 py-3 flex items-center justify-between border-b border-gray-100">
                    ...
                    <div className="flex gap-3 text-xs text-gray-500">
                      ...
                      <span>·</span>
                      <span>{day.totalProteinG}g protein</span>
                      <span>·</span>
                      <span>{day.totalCarbsG}g carbs</span>
                      <span>·</span>
                      <span>{day.totalFatG}g fat</span>
                    </div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-100">
                    {[
                      ...
                      <div key={label} className="p-5">
                        ...
                        {meal.prepTimeMin !== undefined && (
                          <div className="text-xs text-gray-400 mt-2">
                            {meal.prepTimeMin + meal.cookTimeMin} min total
                          </div>
                        )}
                      </div>
                    ))}
