...
const features = [
  {
    title: "Smart Nutrition Calculator",
    desc: "Get your personalized daily calorie and macro targets based on your body, activity, and goals.",
    icon: "🎯",
  },
  {
    title: "AI Meal Plans",
    desc: "Generate complete 7-day meal plans tailored to your diet style — keto, vegan, Mediterranean, and more.",
    icon: "🍽️",
  },
  {
    title: "Instant Recipes",
    desc: "Every meal comes with ingredients, step-by-step instructions, and full nutritional breakdown.",
    icon: "👩‍🍳",
  },
  {
    title: "Auto Grocery Lists",
    desc: "Turn your entire week of meals into a categorized shopping list in one click.",
    icon: "🛒",
  },
];
      ...
      <section className="pt-20 pb-24 px-4 text-center bg-gradient-to-b from-green-50 to-white">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
            Get a personalized meal plan, recipes, and grocery list in minutes.
            Tell us your goals — we&apos;ll handle the rest.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/onboarding"
              className="bg-green-600 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-green-700 transition-colors shadow-lg shadow-green-200"
            >
              Build My Meal Plan →
            </Link>
            <a
              href="#features"
              className="border border-gray-200 bg-white text-gray-700 px-8 py-4 rounded-xl text-lg font-semibold hover:bg-gray-50 transition-colors"
            >
              See How It Works
            </a>
          </div>
      ...
      <section className="py-12 border-y border-gray-100 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4">
          <p className="text-center text-sm font-medium text-gray-500 uppercase tracking-wider mb-6">
            Supports your diet style
          </p>
          <div className="flex flex-wrap gap-3 justify-center">
            {dietStyles.map((d) => (
              <span
                key={d.name}
                className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium ${d.color}`}
              >
      ...
      <section id="features" className="py-24 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-gray-600 mb-16 max-w-xl mx-auto">
            From calculation to cooking — NutriMap AI handles your entire nutrition journey.
          </p>
      ...
      <section className="py-24 px-4 bg-green-50">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { step: "1", title: "Tell us about you", desc: "Enter your age, weight, height, activity level, and nutrition goal." },
              { step: "2", title: "Pick your diet style", desc: "Choose from High Protein, Vegan, Keto, Mediterranean, Vegetarian, or Balanced." },
              { step: "3", title: "Get your plan", desc: "Receive a complete 7-day meal plan with recipes and a ready-to-shop grocery list." },
            ].map((s) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {plans.map((plan) => (
              ...
              >
                ...
                {plan.yearlyPrice && (
                  <p className="text-sm text-gray-500 mb-6">or {plan.yearlyPrice} (save 38%)</p>
                )}
      ...
      <footer className="border-t border-gray-100 py-12 px-4">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-gray-500">
            © 2025 NutriMap AI. All rights reserved.
          </p>
